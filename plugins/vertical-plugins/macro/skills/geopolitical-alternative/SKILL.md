...
description: "[FREE — no API key] Alternative data -- Polymarket prediction markets, CoinGecko Fear & Greed and stablecoin health, UNHCR displacement statistics, Open-Meteo climate anomalies"
---
