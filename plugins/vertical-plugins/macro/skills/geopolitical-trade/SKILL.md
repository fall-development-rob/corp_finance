...
description: "[FREE — public data, free API key required] Trade policy and energy supply data -- EIA petroleum/electricity, WTO tariffs and trade barriers, USASpending federal contract awards"
---
