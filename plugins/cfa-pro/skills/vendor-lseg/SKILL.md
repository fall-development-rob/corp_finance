---
name: vendor-lseg
description: "[PAID — vendor subscription required] LSEG (London Stock Exchange Group) -- bond pricing, yield curve analysis, FX carry trade evaluation, options valuation, macro dashboard via LSEG Financial Analytics MCP"
---
