---
name: data-edgar
description: "[FREE — no API key] SEC EDGAR -- structured XBRL company financial facts, SEC filings (10-K, 10-Q, 8-K), full-text filing search, and CIK/ticker resolution from the SEC directly"
---
