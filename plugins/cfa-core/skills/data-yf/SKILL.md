---
name: data-yf
description: "[FREE — no API key] Yahoo Finance (unofficial) -- equity quotes, historical prices, options chains with Greeks, financial statements, and analyst data. WARNING -- unofficial API, may be unstable"
---
