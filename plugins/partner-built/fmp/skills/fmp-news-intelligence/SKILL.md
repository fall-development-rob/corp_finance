...
description: "[FREEMIUM — free tier with API key] Use the fmp-mcp-server news tools for real-time financial news monitoring, press release tracking, and sentiment analysis across stocks, crypto, and forex. Invoke when monitoring breaking news, tracking press releases, or gathering news sentiment for investment decisions."
---
