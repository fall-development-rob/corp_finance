 ...
 * corresponding .ts file into src/schemas/generated/audit/.
 *
 * Usage (via npm run schemas:gen:audit):
 *   node scripts/gen-audit-schemas.mjs
 */
...
const SCHEMA_SRC = join(WORKSPACE_ROOT, "crates", "corp-finance-core", "target", "schemas", "audit");
const SCHEMA_OUT = join(__dirname, "..", "src", "schemas", "generated", "audit");
