 ...
 * corresponding .ts file into src/schemas/generated/memory/.
 *
 * Usage (via npm run schemas:gen:memory):
 *   node scripts/gen-memory-schemas.mjs
 */
...
const SCHEMA_SRC = join(WORKSPACE_ROOT, "crates", "corp-finance-core", "target", "schemas", "memory");
const SCHEMA_OUT = join(__dirname, "..", "src", "schemas", "generated", "memory");
