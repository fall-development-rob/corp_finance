...
export function registerJurisdictionTools(server: McpServer) {
  ...
  server.tool(
    ...
    WhtSchema.shape,
    async (params) => {
      const validated = WhtSchema.parse(params);
  ...
  server.tool(
    ...
    NavSchema.shape,
    async (params) => {
      const validated = NavSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = GpEconomicsSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = InvestorNetReturnsSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = UbtiScreeningSchema.parse(params);
