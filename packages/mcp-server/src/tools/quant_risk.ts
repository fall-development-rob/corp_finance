...
export function registerQuantRiskTools(server: McpServer) {
  server.tool(
    ...
    async (params) => {
      const validated = FactorModelSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = BlackLittermanSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = RiskParitySchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = StressTestSchema.parse(params);
