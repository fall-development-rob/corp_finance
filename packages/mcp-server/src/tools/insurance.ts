...
export function registerInsuranceTools(server: McpServer) {
  server.tool(
    ...
    async (params) => {
      const validated = ReservingSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = PremiumPricingSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = CombinedRatioSchema.parse(params);
  ...
  server.tool(
    ...
    ScrSchema.shape,
    async (params) => {
      const validated = ScrSchema.parse(params);
