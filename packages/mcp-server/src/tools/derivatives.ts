...
import { priceOption, impliedVolatility, priceForward, valueForwardPosition, futuresBasisAnalysis, valueInterestRateSwap, valueCurrencySwap, analyzeStrategy } from "corp-finance-bindings";
...
export function registerDerivativesTools(server: McpServer) {
  server.tool(
    ...
    async (params) => {
      const validated = OptionPriceSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = ImpliedVolSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = ForwardPriceSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = ForwardPositionSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = BasisAnalysisSchema.parse(params);
  ...
  server.tool(
    ...
    IrsSchema.shape,
    async (params) => {
      const validated = IrsSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = CurrencySwapSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = StrategySchema.parse(params);
