...
export function registerFpaTools(server: McpServer) {
  server.tool(
    ...
    async (params) => {
      const validated = VarianceSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = BreakevenSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = WorkingCapitalSchema.parse(params);
  ...
  server.tool(
    ...
    async (params) => {
      const validated = RollingForecastSchema.parse(params);
