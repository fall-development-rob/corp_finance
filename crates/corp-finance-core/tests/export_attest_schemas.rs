...
mod attest_schemas {
    use corp_finance_core::federation::{TrustAttestation, AttestationStatus, AttestationRevocation};
    ...
    #[test]
    fn export_trust_attestation() { emit::<TrustAttestation>("TrustAttestation"); }

    #[test]
    fn export_attestation_status() { emit::<AttestationStatus>("AttestationStatus"); }

    #[test]
    fn export_attestation_revocation() { emit::<AttestationRevocation>("AttestationRevocation"); }
}
