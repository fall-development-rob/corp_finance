...
CFA agents have access to 195 analytical tools (via corp-finance-mcp) and 181 market data tools
...
|------------------|------------------------|------------------------|
| Analytical tools | 195 (corp-finance-mcp) | Yes                    |
...
- **Automatic data flow.** All 195 analytical tools automatically receive real financial data
  via `buildToolParams()`.
...
- No changes to the 195 analytical tools or their Zod schemas.
