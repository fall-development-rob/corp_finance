...
---
name: data-aiera
description: "Aiera -- earnings call transcripts, event intelligence, company event monitoring via Aiera MCP. Use when researching earnings call commentary, management guidance, or scheduled corporate events."
---
